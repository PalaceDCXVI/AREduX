    ...
    public class myInpainter2 : LinkableBaseEffect
    {
        ...
        private void computeMask()
        {
            if (useComputeShader && SystemInfo.supportsComputeShaders)
            {
                ...
                shader = (ComputeShader)Resources.Load("OpenVisSim/ExperimentalInpainterA");
        ...
        private void compute()
        {
            if (useComputeShader && SystemInfo.supportsComputeShaders)
            {
                ...
                shader2 = (ComputeShader)Resources.Load("OpenVisSim/ExperimentalInpainterB");
        ...
        Vector2 xy_norm_prev = new Vector2(0.0f, 0.0f);
		...
		protected override void OnUpdate()
        {
            ...
            {
                //Debug.Log("xyNorm: " + xy_norm);
                xy_norm_prev = xy_norm;
            }
